...
import jp.techacademy.hideaki.tanigawa.qa_app.databinding.ActivityLoginBinding

class LoginActivity : AppCompatActivity() {
    private lateinit var binding: ActivityLoginBinding

    private lateinit var auth: FirebaseAuth
    private lateinit var createAccountListener: OnCompleteListener<AuthResult> // 処理の完了を受け取るクラス
    private lateinit var loginListener: OnCompleteListener<AuthResult> // 処理の完了を受け取るクラス
    private lateinit var databaseReference: DatabaseReference //DBの書き込みに必要なクラス
