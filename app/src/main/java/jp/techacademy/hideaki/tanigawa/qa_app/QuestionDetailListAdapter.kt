...
import jp.techacademy.hideaki.tanigawa.qa_app.databinding.ListAnswerBinding
import jp.techacademy.hideaki.tanigawa.qa_app.databinding.ListQuestionDetailBinding

class QuestionDetailListAdapter(context: Context, private val question: Question) : BaseAdapter() {
    // どのレイアウトを使って表示させるかを判断するためのタイプ
    companion object {
        private const val TYPE_QUESTION = 0
        private const val TYPE_ANSWER = 1
    }

    // LayoutInflaterはActivityのgetLayoutInflater()メソッドを使うとlayoutInflaterを取得できる。
    private var layoutInflater: LayoutInflater

    init {
        // LayoutInflaterを取得している
